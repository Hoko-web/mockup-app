#!/bin/bash
# Embed every assets/*.webp into mockup_generator.html → produce a single-file index.html
set -e
cd "$(dirname "$0")"
...
bases = ['base.webp', 'laptop_only.webp', 'phone_only.webp']
...
for fname in bases:
    ...
    replacement = f"base: 'data:image/webp;base64,{b64}'"
